    ...
    await transport.sendMail({
        ...
        <body>
            <div class="email-container">
                ...
                <div class="content">
                    <p>Has solicitado actualizar tu contraseña para acceder a tu cuenta de Bienes Raíces. Para hacerlo, por favor haz clic en el siguiente enlace:</p>

                    <a href="https://ibb.co/4pnjfnb" style="display: block; text-align: center; margin-bottom: 20px;">
                        <img src="https://i.ibb.co/yqc8Rcz/firma.png" alt="firma" border="0" style="max-width: 200px;">
                    </a>

                    <a href="${process.env.BACKEND_URL}:${process.env.BACKEND_PORT ?? 3000}/auth/passwordRecovery/${token}" class="btn">
                        Actualizar Contraseña
                    </a>
                </div>
                <div class="footer">
                    <p>Si no has solicitado la actualización de contraseña, por favor ignora este correo.</p>
                </div>
            </div>
        </body>
        </html>
